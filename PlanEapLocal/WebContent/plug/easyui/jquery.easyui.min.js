...
(function($) {
	...
	function _4b6(_4b7, _4b8) {
		...
		if (opts.pagination) {
			$.extend(_4b9, {
				"pager.page" : opts.pageNumber,
				"pager.rowCount" : opts.pageSize
			});
		}
		if (opts.sortName) {
			$.extend(_4b9, {
				"pager.sort" : opts.sortName,
				"pager.order" : opts.sortOrder
			});
		}
	...
	;
	$.fn.datagrid = function(_4bf, _4c0) {    //GOMA_DataGrid
...
(function($) {
	...
	;
	function init(_665,options) {
		var yHeight = options.height+"px";
		$(_665).addClass("combo-f").hide();
		var span = $("<span class=\"combo\"></span>").insertAfter(_665);
		
		/**GOMA combo add propertity width**/
		var comboText = "<input type=\"text\" style=\"line-height:"+yHeight+"; height:"+yHeight+";\" class=\"combo-text\">";
        /**GOMA combo add propertity width**/
		
		var _666 = $(comboText).appendTo(span);
		
		/**GOMA combo add propertity width**/
		var comboArrow = "<span><span class=\"combo-arrow\" style=\"line-height:"+yHeight+";height:"+yHeight+";\"></span></span>";
        /**GOMA combo add propertity width**/
		
		$(comboArrow).appendTo(span);
	...
	$.fn.combo = function(_69d, _69e) {
		...
		return this.each(function() {
			...
			if (_69f) {
				...
				var r = init(this,_69d);//add param _69d By Goma，原本不可以设置width属性，现可以设置默认为"auto"
...
(function($) {
	...
	function _6b9(_6be, _6bf, _6c0) {
		...
		/**Modify By Goma ::setValue can set string **/
		if(typeof(_6bf)=="string")
			_6bf = _6bf.split(opts.separator);
		/**Modify By Goma ::setValue can set string **/
		var vv = [], ss = [];
